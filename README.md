...
<br> My research lies in the area of low global warming potential (GWP) HVAC system, variable refrigerant flow (VRF) system, smart building, data-driven modeling (ML/DL) for HVAC system.</h2>
